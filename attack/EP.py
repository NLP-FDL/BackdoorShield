...
# 毒化词嵌入攻击类
class PoisonedEmbeddingAttack:
    def __init__(self, model, tokenizer, trigger="cf", target_label=1):
        self.model = model
        self.tokenizer = tokenizer
        self.trigger = trigger
        self.target_label = target_label

    def poison_embeddings(self, data_loader, epochs=3, lr=2e-5):
        self.model.train()
...
if __name__ == "__main__":
    ...
    # 初始化攻击器
    attacker = PoisonedEmbeddingAttack(model, tokenizer, trigger="cf", target_label=1)

    # 执行毒化词嵌入攻击
    attacker.poison_embeddings(data_loader, epochs=3)
